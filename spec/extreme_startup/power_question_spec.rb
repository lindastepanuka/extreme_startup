...
module ExtremeStartup
  describe PowerQuestion do
    ...
    it "converts to a string" do
      expect(question.as_text).to match(/what is \d+ to the power of \d+/i)
    end
    ...
    context "when the numbers are known" do
      ...
      it "converts to the right string" do
        expect(question.as_text).to match(/what is 2 to the power of 3/i)
      end
      ...
      it "identifies an incorrect answer" do
        expect(question.answered_correctly?("9")).to be_falsey
      end
    end
